import { getBatchedMeshLODCount, simplifyGeometriesLODAuto } from '@three.ez/batched-mesh-extensions';
...
const geometriesLODArray = await simplifyGeometriesLODAuto(geometries, 4, [0.02, 0.03, 0.07, 0.15]);
